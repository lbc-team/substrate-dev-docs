...
[系统库](https://substrate.dev/rustdocs/v2.0.0/frame_system/index.html) 为你的区块链提供了底层的类型、存储以及函数。所有其他的pallet都依赖于系统库作为 Substrate 运行时的基础。
...
[FRAME Executive 模块](https://substrate.dev/rustdocs/v2.0.0/frame_executive/index.html)充当rumtime 的调度层。 它将传入的外部调用分发到对应的pallet。


### 支持库(Support Library)

[FRAME 支持库](https://substrate.dev/rustdocs/v2.0.0/frame_support/index.html) 一组Rust宏，类型，traits，以及用于简化 Substrate pallet 开发的函数组成。
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/frame_benchmarking/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_assets/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_atomic_swap/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_aura/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_authority_discovery/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_authorship/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_babe/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_balances/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_benchmark/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_collective/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_contracts/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_democracy/index.html)
- [源码](https://github.com/paritytech/substrate/blob/master/frame/democracy/src/lib.rs)

### Elections Phragmén

Elections Phragmén pallet 是一个基于[sequential Phragmén](https://wiki.polkadot.network/docs/en/learn-phragmen)的选举模块


- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_elections_phragmen/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_elections/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_evm/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_example_offchain_worker/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_example/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_finality_tracker/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_grandpa/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_identity/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_im_online/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_indices/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_membership/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_multisig/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_nicks/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_offences/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_proxy/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_randomness_collective_flip/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_recovery/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_scheduler/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_scored_pool/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_session/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_society/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_staking/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_sudo/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_timestamp/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_transaction_payment/index.html)
...
<<<<<<< HEAD
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_treasury/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_utility/index.html)
...
- [文档](https://substrate.dev/rustdocs/v2.0.0/pallet_vesting/index.html)
...
- 跟随教程[在你的 FRAME 运行时里添加一个pallet](../../tutorials/add-a-pallet/).

### 参考文档

- 访问[系统库](https://substrate.dev/rustdocs/v2.0.0/frame_system/index.html) 文档。

- 访问[Executive pallet](https://substrate.dev/rustdocs/v2.0.0/frame_executive/index.html)文档。

- 访问[FRAME support library](https://substrate.dev/rustdocs/v2.0.0/frame_support/index.html)文档。
